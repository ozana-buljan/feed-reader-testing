...
$(function () {
    ...
    describe('New Feed Selection', function () {
        ...
        let previousFeeds, //saves html of an old feed
            newFeed; //saves html of a new feed
        ...
        it('is different from the previous feed selection', function (done) {
            expect(previousFeeds !== newFeed).toBe(true);
            done();
        });
    });
